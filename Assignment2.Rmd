...
p <- ggplot(data = world, aes(x = Year)) +
  ...
  # Add blue line for males and attach to legend
  geom_line(aes(y = Male_Pop_Thousands, color = "Male"), show.legend = TRUE) +
  
  # Add pink line for females and put on the legend
  geom_line(aes(y = Female_Pop_Thousands, color = "Female"), show.legend = TRUE) +
  ...
  # Specify manual color scale and labels
  scale_color_manual(values = c("#B85887", "#2768A4"), labels = c("Male", "Female"), name = "Gender")
