...
averages_df <- data.frame(
  ...
  `Avg_Male_Pop` = averages$Male_Pop_Thousands,
  `Avg_Female_Pop` = averages$Female_Pop_Thousands,
  `Avg_Sex_Ratio` = averages$Sex_Ratio
)
...
Within this data set is `r ncol(sex1)` columns. There are `r nrow(sex1)` records in this  data set. Each row accounts for a single years' measurement for the associated region.